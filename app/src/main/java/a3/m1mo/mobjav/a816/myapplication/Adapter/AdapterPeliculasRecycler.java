...
/**
 * Created by Diagnostifo on 25/10/2016.
 */
public class AdapterPeliculasRecycler extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public AdapterPeliculasRecycler(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        PeliculasViewHolder peliculasViewHolder = new PeliculasViewHolder(viewDeLaCelda);
