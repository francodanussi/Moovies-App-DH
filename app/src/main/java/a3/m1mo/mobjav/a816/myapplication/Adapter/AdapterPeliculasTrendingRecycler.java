...
public class AdapterPeliculasTrendingRecycler  extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public AdapterPeliculasTrendingRecycler(Context context) {
        this.context = context;
    }

    private class PeliculasTrendingViewHolder extends RecyclerView.ViewHolder {
        private TextView textViewTituloPelicula;
        private TextView textViewRatingPelicula;
        private ImageView imageViewImagenPelicula;

        public PeliculasTrendingViewHolder(View view){
            super(view);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AdapterPeliculasTrendingRecycler.PeliculasTrendingViewHolder peliculasTrendingViewHolder = new AdapterPeliculasTrendingRecycler.PeliculasTrendingViewHolder(viewDeLaCelda);
        viewDeLaCelda.setOnClickListener(this);
        return peliculasTrendingViewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        Pelicula unaPelicula = listaDePeliculas.get(position);
        AdapterPeliculasTrendingRecycler.PeliculasTrendingViewHolder peliculasViewHolder = (AdapterPeliculasTrendingRecycler.PeliculasTrendingViewHolder)holder;
