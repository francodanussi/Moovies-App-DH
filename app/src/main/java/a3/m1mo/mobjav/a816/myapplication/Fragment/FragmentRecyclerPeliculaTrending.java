...
import a3.m1mo.mobjav.a816.myapplication.Adapter.AdapterPeliculasTrendingRecycler;
...
public class FragmentRecyclerPeliculaTrending extends Fragment {


    private RecyclerView unRecyclerView;
    private List<Pelicula> listaDePeliculas;
    private AdapterPeliculasTrendingRecycler unAdapter;
    private seleccionableDePelicula seleccionableDePelicula;
    private Context context;
    private SwipeRefreshLayout pullToRefresh;
    private PeliculaController peliculaController;

    public FragmentRecyclerPeliculaTrending() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context = getContext();
        View view = inflater.inflate(R.layout.fragment_recycler_peliculas_trending, container, false);
        ListenerDePelicula listenerDePelicula = new ListenerDePelicula();
        unRecyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewPeliculasTrending);
        ...
        unAdapter = new AdapterPeliculasTrendingRecycler(context);
        CargarPeliculas();
