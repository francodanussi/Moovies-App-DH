...
public class FragmentViewPagerPeliculaDocumental extends Fragment {
    ...
    public FragmentViewPagerPeliculaDocumental() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_view_pager_pelicula_documental, container, false);
