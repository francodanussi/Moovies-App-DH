...
import a3.m1mo.mobjav.a816.myapplication.Fragment.FragmentRecyclerWatchLater;
import a3.m1mo.mobjav.a816.myapplication.R;

/**
 * Created by Diagnostifo on 01/12/2016.
 */
...
public class WatchLaterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentRecyclerWatchLater fragmentRecyclerWatchLater = new FragmentRecyclerWatchLater();
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.replace(R.id.aca_va_el_fragment_watchlater, fragmentRecyclerWatchLater);
        ...
        drawerLayout = (DrawerLayout) findViewById(R.id.WatchLaterDrawerLayout);
    ...
    public void seleccionItem(MenuItem unItem) {
        ...
        switch (unItem.getItemId()) {
            ...
            case R.id.IDNavigationViewFavoritos:
                Intent favoriteIntent = new Intent(this, FragmentRecyclerFavoriteTotal.class);
